    ...
    if (initialLoading) {
        return (
            <div className="p-24 flex flex-col items-center justify-center gap-4">
                ...
                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest animate-pulse">Initializing Interface...</p>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-10 pb-32 animate-in fade-in slide-in-from-bottom-5 duration-1000">
            <div className="flex items-center space-x-6">
                ...
                <div>
                    <h1 className="text-4xl font-black text-foreground tracking-tighter">Modify Asset</h1>
                    <p className="text-muted-foreground text-sm font-medium mt-1">Update configuration for an existing inventory entity.</p>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-12">
                        ...
                        <div className="md:col-span-2 space-y-4 pt-4 border-t border-border mt-4">
                            ...
                            <div className="flex items-start space-x-6">
                                <div className="flex-1">
                                    ...
                                    />
                                    <p className="mt-3 text-[10px] font-bold text-muted-foreground uppercase tracking-tight opacity-60">Leave empty to retain legacy media profile.</p>
                                </div>
                                {formData.imageUrl && (
                    ...
                    <div className="flex justify-end items-center space-x-6 pt-10 border-t border-border">
                        ...
                        >
                            ...
                            {loading ? 'Synchronizing...' : 'Sync Asset Configuration'}
                        </button>
                    </div>
                </form>
            </div>
